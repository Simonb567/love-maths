...
* directly from the dom, and retirns the correct answer
*/
...
/**
* Gets the current score from the the DOM and increments it by 1
*/
...
function displaySubtractQuestion(operand1, operand2) {
  ...
  // Above acts like an IF Statement. If operand 1 > operand2, display operand 1, if not display operand2
  document.getElementById("operator").textContent = "-";
}
